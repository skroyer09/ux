...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (loggedInUser) {
        ...
        const logoutSVG = `<svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        const profileSVG = `<svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
